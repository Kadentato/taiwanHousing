...
const QUESTION_PRESETS = {
  ...
  size:     { metric: "ping",  title: "Where do you get room to breathe?",
              ...
              finding: `The typical home runs from about <b>9 ping</b> in dense cores to nearly <b>60</b> at the edges — where roomy and cheap-per-ping go together, though that's <b>location</b>, not size, setting the price.`,
              read: {
                ...
                <p>So on the map, more floor space and a lower price per ping travel together — but read that carefully. It is <em>not</em> that a home is cheaper <em>because</em> it is roomy; the roomy homes and the cheap-per-ping homes are the <b>same</b> homes — the ones out in the suburbs and townships. <b>Location is the confounder</b> sitting behind both. Strip out where a home sits and that tidy "bigger for less" line would largely dissolve: it is a correlation with a lurking variable, not roominess setting the price. What you are really buying at the edge is cheaper land and a longer commute — the extra space just comes along for the ride.</p>` } },
